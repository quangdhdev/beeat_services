                    ...
                    {[
                      {
                        ...
                        description:
                          'Nhận thông báo về khóa học và hoạt động tài khoản',
                      },
                      {
                        key: 'courseUpdates',
                        label: 'Cập nhật khóa học',
                        description:
                          'Thông báo khi có bài học mới hoặc cập nhật nội dung',
                      },
                      {
                        key: 'promotions',
                        label: 'Khuyến mãi và ưu đãi',
                        description:
                          'Nhận thông tin về các chương trình giảm giá',
                      },
                      {
                        key: 'weeklyDigest',
                        label: 'Tóm tắt hàng tuần',
                        description:
                          'Báo cáo tiến độ học tập và khuyến nghị khóa học',
                      },
                    ].map((item) => (
                      <div
                        key={item.key}
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        {[
                          {
                            date: '15/01/2025',
                            course: 'Selenium WebDriver với Java',
                            amount: '1,990,000₫',
                          },
                          {
                            date: '10/01/2025',
                            course: 'Cypress - Modern E2E Testing',
                            amount: '1,790,000₫',
                          },
                        ].map((payment, index) => (
                          <div
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between py-4 border-b border-gray-200">
                      <div className="flex-1">
                        <h3 className="text-sm font-medium text-gray-900">
                          {t('settings.preferences.darkMode.title')}
                        </h3>
                        <p className="text-sm text-gray-500 mt-1">
